...
if (isset($_POST['btnRegister'])) {
  ...
  if (empty($err)) {
    ...
    $sql = "INSERT INTO users(email,phone , passWord,fullname,avatarUser,vkey) 
            VALUES('$email','$phone' , '$hashpwd' , '$name','$path','$vkey')";
    ...
    if ($query) {
      ...
      $mail->Username = "thevu2468@gmail.com";

      //Password to use for SMTP authentication
      $mail->Password = "icbzjhfculrtswja";

      //Set who the message is to be sent from
      $mail->setFrom('thevu2468@gmail.com', 'Khach san Holiday Crown');

      //Set an alternative reply-to address
      $mail->addReplyTo('thevu2468@gmail.com', 'xac minh tai khoan');
      ...
      $mail->msgHTML("<a href='http://localhost/project_PHP/client/verification.php?vkey=$vkey'>Click here to verification Email</a>");
            ...
            <div class="card-body p-md-5">
              <div class="row justify-content-center">
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  ...
                  <a href="../admin/login.php" class="modify"> Quay trở lại trang đăng nhập?</a>
